...
- **영어 번역 괄호 표기 (예: "목(wood)", "기운(energy)", "균형(balance)")**
...
1. **dayPillar**: 일주 ${result.bazi.day} 분석
   - characteristic: 이 일주를 한눈에 사로잡는 강렬한 한줄로 표현 (15자 내외)
     - 눈길을 끄는 자극적이고 매력적인 표현 사용
     - 좋은 예: "타고난 승부사의 DNA", "본능적인 매력 폭발", "누구도 막을 수 없는 불꽃", "돈과 인연이 따르는 팔자"
     - 나쁜 예: "추진력 있는 성격", "안정적인 사람" (너무 평범함)
...
- **color**: 오늘의 행운 컬러 (다양하게 랜덤 선택!)
  - name: 색상명 - 아래 목록에서 **매번 다른 색상**을 선택하세요
    - 빨강, 와인, 코랄, 피치, 오렌지, 노랑, 아이보리, 연두, 카키, 민트, 초록, 하늘색, 파랑, 네이비, 보라, 라벤더, 핑크, 베이비핑크, 베이지, 브라운, 회색, 흰색, 검정, 골드, 실버, 무지개색
  - tip: 코디 팁 (**30자 이상**, 구체적으로!)
    - 예: "오늘의 행운 컬러는 민트! 민트색 액세서리나 양말로 포인트를 줘보세요!"
