...
### 1. 나의 일주 (${result.bazi.day})

**[일주특징]**
이 일주를 가진 사람을 15자 내외로 표현하는 한줄 특징을 작성해주세요.
반드시 "[일주특징]" 바로 다음 줄에 특징만 작성하세요. 따옴표나 설명 없이 특징만 작성합니다.
예시:
[일주특징]
추진력 넘치는 행동파

**[일주해석]**
이 일주를 가진 사람의 타고난 본성, 핵심 성격, 매력 포인트, 인생의 방향성을 300자 내외로 설명해주세요.
반드시 "[일주해석]" 바로 다음 줄부터 해석을 작성하세요.
- 절대로 500자를 넘지 마세요
- 일주의 동물과 색깔의 의미를 포함해주세요
- 이 사람만의 독특한 매력을 표현해주세요
