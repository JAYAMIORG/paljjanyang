...
// 천간 → 색상 (친근한 표현 + 한자어)
export const TIANGAN_COLOR: Record<string, { friendly: string; short: string }> = {
...
// 지지 → 동물 (친근한 표현 + 한자어)
export const DIZHI_ANIMAL: Record<string, { friendly: string; short: string }> = {
...
// 간지에서 육십갑자 별칭 가져오기 (예: 庚戌 → 하얀 강아지 (백개))
